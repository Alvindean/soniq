...
const SUBSTYLE_NOTES={
  ...
  'Pop-Rap Rock':        'Pop-Rap Rock DNA: 95-130 BPM. The "rapped over a pop-punk band" niche distinct from Pop-Rap Crossover (which is 808-leaning). Live drum kit (snare on 2 and 4, kick on 1 and 3), pop-punk power chord guitar (drop-D sometimes but not nu-metal heavy), bouncy bass, sometimes funk-pocket guitar (RHCP-leaning lineage), occasional sampled chorus hook (Cupid\'s Chokehold uses Supertramp\'s "Breakfast in America"; Asher Roth "I Love College" uses Weezer\'s "Say It Ain\'t So"), polished pop mix. Vocal architecture: [Rapped] verse (the lead — Travie / Tyler Joseph / Yelawolf / B.o.B. register, technically dense rap delivery) + [Featured Vocalist] sung anthemic chorus (the GCH signature — Patrick Stump on "Cupid\'s Chokehold", Adam Levine on "Stereo Hearts", Ryan Tedder on "The Fighter"; also TOP\'s Tyler Joseph alternates within himself) + [Half-Rapped Bridge] OR [Stripped Acoustic Bridge] + [Sample Hook] occasional + [Group Whoa-Oh Tag] for crowd-singalong. RHYME SCHEME — two-regime per song-section: (1) Rapped verses use AABB couplets with DENSE internal rhymes (Travie was technically dense — multisyllabic-rhyme welcome, conversational diction). (2) Featured-vocalist chorus uses ABAB melodic-pop form with long-vowel ends so the guest vocalist can sustain ("hearts/parts", "fighter/lighter", "free/me"). Bridge often half-rapped. Themes: love-via-pop-rap-lens (the Travie-McCoy specialty), scene-life and post-college anxiety, party with self-aware modernity, sample-driven nostalgia bars, mainstream relationship mess, Fueled By Ramen scene-pride, going-out-on-a-Tuesday hedonism, romantic devotion mixed with rap-swagger. Ad-libs: "(yeah)", "(uh)", "(c\'mon!)", "(let me hear you!)" guest-hook call, "(hands up!)", "(stand up!)", "(make some noise!)", group "(woah-oh-oh)" pop-punk-singalong (the genre signature crowd ad-lib), "(let\'s go!)", [Drum Build], [Power Chord Wall], [Featured Vocalist Hook], [Sample Hook] tag for sample-driven choruses, [Crowd-Call Setup]. Suno style: "pop-rap rock, rapped verse over pop-punk power chord backing, live drum kit, bouncy bass, featured vocalist sung anthemic chorus, optional sampled hook, 110 BPM, mid-2000s Fueled By Ramen onward". Artists: Gym Class Heroes, Travie McCoy (solo), Yelawolf, Twenty One Pilots (rap-rock leaning), Hollywood Undead, B.o.B., Asher Roth, 3OH!3, Sam Adams, Mike Shinoda (Fort Minor), MGK (rock-rap era), Kid Cudi (rock-leaning), Eminem (D12 rock-leaning), Atmosphere (indie-rap-rock), Lupe Fiasco (rock-leaning), Beastie Boys (proto pop-rap-rock).',
...
const SUBSTYLE_SUNO = {
  ...
  'Pop-Rap Rock':       'pop-rap rock, rapped verse over pop-punk power chord backing, live drum kit, bouncy bass, featured vocalist sung anthemic chorus, optional sampled hook, 110 BPM, mid-2000s Fueled By Ramen onward, Gym Class Heroes / Travie McCoy / Yelawolf / Twenty One Pilots / Hollywood Undead / B.o.B. / Asher Roth',
...
const SUBSTYLE_BRACKETS={
  ...
  'Pop-Rap Rock':            { verse:'[Verse | Rapped | Pop-Punk Power Chord Backing | Live Drum Kit]',     hook:'[Chorus | Featured Vocalist | Sung Anthemic Hook | Power Chord Wall]', extra:['[Pre-Chorus | Drum Build | Crowd-Call Setup]','[Bridge | Stripped Acoustic OR Half-Time Rapped]','[Sample Hook | Optional | Sample-Driven Production]','[Final Chorus | Layered Group Vocal + Whoa-Oh Tag | Crowd-Ready]'] },
...
const GENRE_SUBSTYLE_LISTS = {
  hiphop:    ['Trap','Boom Bap','Lyrical/Conscious','Drill','Melodic Rap','Old School','G-Funk','Bay Area','Down South','Crunk','Chopped & Screwed','East Coast','Midwest','Cloud Rap','Phonk','Pop-Rap Crossover','Pop-Rap Rock'],
...
const CROSSOVER_TAXONOMY = {
  ...
  brackets: {
    ...
    '[DJ Scratch]':         ['hiphop','metal-numetal','funk-rock','new-jack-swing','pop-rap-rock'],
    '[Vocoder]':            ['p-funk','jazz-fusion','disco-pop','synth-pop','hyper-pop','boogie'],

    // COLLABORATION & SAMPLE SIGNATURES (Wave 4a)
    // [Featured Vocalist] — the canonical "different singer takes the chorus"
    // architecture. Eminem×Dido (Stan), Jay-Z×Alicia Keys (Empire State of
    // Mind), T.I.×Rihanna (Live Your Life), Linkin Park×Jay-Z (Numb/Encore),
    // Gym Class Heroes×Patrick Stump (Cupid's Chokehold), GCH×Adam Levine
    // (Stereo Hearts), GCH×Ryan Tedder (The Fighter), Travis Scott×guest hooks.
    '[Featured Vocalist]':  ['hiphop','pop-rap','metal-numetal','rnb','pop','pop-rap-rock','gospel','reggaeton','jazz-fusion','funk-rock'],
    // [Sample Hook] — the "chorus melody is a famous sample" architecture.
    // Cupid's Chokehold (Supertramp Breakfast in America), Kanye whole catalog,
    // J. Cole Work Out (Paula Abdul), Saweetie Best Friend, Daft Punk One More
    // Time (samples), most pop-rap, Wu-Tang sample-flips, modern-funk sample
    // revival.
    '[Sample Hook]':        ['hiphop','pop-rap','pop-rap-rock','nu-jazz','p-funk','modern-funk','soul-jazz-acid-jazz','house']
  },
  ...
  adlibs: {
    ...
    // CONCERT-CALL / FESTIVAL-ANTHEM AD-LIBS (Wave 4a)
    // Universal crowd-participation calls — bridge pop-rap, pop-punk, rock-anthem,
    // festival-edm, hardstyle, gospel-call. Use sparingly (1-2 per song max for
    // the anthem moment, not per-bar filler).
    '(let me hear you!)':    'pop-rap-rock (GCH guest-hook signature), gospel call-and-response, festival-edm, anthem rock — concert call-and-response',
