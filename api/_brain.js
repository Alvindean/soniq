...
const GENRE_BIBLE={
  ...
  brazilian:{dna:'Portuguese warmth meets rhythmic complexity. Violão fingerpicking, pandeiro swing, emotional vulnerability layered with sophisticated chord changes. The genre embraces melancholy joy — the bittersweet heart of Brazilian culture. Samba and bossa nova are meditation and celebration simultaneously.',structure:'Bossa Nova/Samba: Verse (narrative, conversational) → Chorus (singable, emotional core, repeats 2-3×) → Bridge (traditional guitar break or tempo shift) → Final Chorus. MPB/Funk Carioca: longer intros, layered verses, explosive choruses, ad-libbed finishes. Sertanejo: story-driven verses, anthemic chorus, romantic or celebration energy.',suno:'"bossa nova, portuguese lyrics, nylon guitar, sophisticated chords, subtle percussion, 100 BPM, warm" for classic. "samba, brazilian drums, tamborine, energetic, 110 BPM, celebratory" for samba. "funk carioca, 808 bass, digital drums, aggressive, 90 BPM, party" for funk. "MPB, acoustic guitar, string arrangement, 95 BPM, poetic" for MPB.',keys:['Rhythmic complexity: the percussion (pandeiro, cuíca, surdo) must weave polyrhythmic texture, not just keep time','Violão is a character — fingerpicking patterns create the emotional memory, use specific open tunings (E-A-D-G-B-E vs. open D)','Portuguese lyrics create intimacy — monosyllabic or two-syllable words land harder than English translations','Second verse deepen emotionally, add a new story layer or recontextualize the first verse truth','The chorus must be singable for a non-Portuguese speaker — rhythmic and melodic clarity matter more than lyrical complexity'],artists:'Tom Jobim · João Gilberto · Caetano Veloso · Gilberto Gil · Marisa Monte · Anitta · Jorge Ben Jor · Tim Maia · Seu Jorge · MC Kevinho',counter:{device:'Violão fingerpicking / pandeiro counter-rhythm / string counter-line',does:'The violão plays an independent fingerpicking pattern that weaves around the vocal melody — it\'s the conversation partner. The pandeiro (tambourine) creates a rhythmic counter-texture that\'s not just accompaniment but a melodic counter-rhythm. In arranged versions, strings play a sweeping counter-line underneath the vocal, adding harmonic warmth.',howto:'violão fingerpicking counter-melody, pandeiro rhythmic counter-texture, string arrangement counter-line',map:'Verse: violão pattern is the emotional anchor under sparse vocals / Chorus: pandeiro counter-rhythm drives the groove / Bridge: violão takes melodic lead with string counter-line / Outro: violão and vocals interweave'},outliers:[{song:'"Girl from Ipanema" — Tom Jobim & João Gilberto',rule:'Soft-spoken bossa nova that broke every samba energy convention with whisper-quiet vocals',result:'One of the most successful songs ever recorded, proved restraint and sophistication beat bombast'},{song:'"Aquele Abraço" — Gilberto Gil',rule:'Slang-heavy street Portuguese with minimal melody — almost rap-like delivery in bossa context',result:'Became an anthem of Brazilian resistance, proved colloquial language could carry poetic weight'},{song:'"Eu Sou Negra" — Alcione',rule:'Deep diva vocals with dramatic operatic inflection breaking bossa nova\'s gentle restraint',result:'Iconic album that expanded Brazilian soul beyond the gentle tradition, proved passion could magnify the genre'}],vocables:{sounds:'ahh, ooh, la-la-la, eh',when:'chorus response, bridge vocable hum, outro fade',suno_tag:'[Brazilian vocal ahh]',borrowed_from:'Portuguese oral tradition, African rhythmic call-response',notes:'Brazilian vocables often ride the pandeiro rhythm — they\'re percussive not purely melodic. Use them to emphasize the swing and syncopation'}},
  amapiano:{dna:'Log drum bass syncopation, jazzy suspended piano chords (that never fully resolve), shaker percussion, 110-115 BPM lockstep groove. Zulu/English lyrics in a conversational tone. Township energy meets global dancefloor. The groove IS the song — melody serves the beat.',structure:'Hook-first: Opening 8-16 bars of pure instrumental groove setting the vibe. Verse (conversational, minimal melody) → Chorus (hook repeats 4-6 times) → Verse 2 → Chorus → Bridge (beat breakdown or piano riff escalation) → Final Chorus → Outro (groove vamp fades). Instruments constantly evolve but beat never stops.',suno:'"amapiano, log drum, piano chords, shaker, 110 BPM, south african, township, groove" for classic. "amapiano ballad, slower tempo, melodic piano, emotional" for ballad. "amapiano energetic, fast-paced, driving beat, celebration" for party.',keys:['The log drum bass line is the hook — it must be hypnotic and instantly recognizable','Piano chords should use 7sus4, 9sus4, maj7 extensions — never resolve fully, keep tension','Lyrics are conversational and often bilingual (Zulu + English mix) — the beat carries emotion, lyrics carry narrative','Verse momentum building: each verse should feel slightly more energetic than the last, build anticipation for the drop','Shaker and hi-hat variations create micro-momentum shifts — the groove is the detail work'],artists:'Kabza De Small · DJ Maphorisa · Uncle Waffles · Tyla · Focalistic · DBN Gogo · Daliwonga',counter:{device:'Piano chord counter / log drum syncopation / secondary hi-hat pattern',does:'Amapiano\'s counter-melody is primarily rhythmic: the log drum plays a syncopated counter-line against the kick, the piano arpeggiation creates a counter-harmonic layer, and layered hi-hat patterns provide textural counterpoint. The rhythm IS the melody.',howto:'log drum syncopation counter, piano arpeggio counter-line, hi-hat textural counter-rhythm',map:'Throughout: log drum never stops, always counter-syncopated / Verse: piano creates harmonic counter / Chorus: hi-hat variations add rhythmic counter-texture / Bridge: drums break, piano counter-line becomes primary'},outliers:[{song:'"Essence" — Wizkid ft. Tems',rule:'Minimal sparse production breaking amapiano\'s trademark dense percussion layering',result:'One of the biggest global crossover hits, proved amapiano power survives stripping the production'},{song:'"Ye" — Burna Boy',rule:'Deep emotional vulnerability contradicting the genre\'s dance-floor party energy',result:'Showed amapiano could carry emotional ballad weight while maintaining the groove'},{song:'"Amapiano to the World" — Kabza De Small & DJ Maphorisa',rule:'South African local anthem with zero global crossover production compromises',result:'Became global despite (not because of) accessibility, proved authentic township culture resonated globally'}],vocables:{sounds:'eh, yeah, yay, alright',when:'chorus hook, outro vamp, between verses as response',suno_tag:'[Amapiano call]',borrowed_from:'Zulu call-response tradition, South African township culture',notes:'Amapiano vocables are rhythmic and energetic — they ride the beat as percussive elements, not as separate melodic moments. Keep them short and punchy'}},
  dancehall:{dna:'Digital riddims, toasting over heavy electronic production, 90-110 BPM swagger. Dancehall is rap\'s Jamaican cousin: the lyrical density, flow variation, and boasting tradition of hip-hop married to reggae\'s one-drop spirituality and dancehall\'s electronic urgency. Patois is a feature, not a translation.',structure:'Intro riddim (8-16 bars) → Verse 1 (toasting, rapid-fire delivery) → Chorus (hook repeats 3-5×, often sung by chorus artist) → Verse 2 → Chorus → Bridge (riddim shift or deejay breakdown) → Final Chorus → Outro (riddim vamp fades or abrupt cut). Speed and energy peak at verses.',suno:'"dancehall, riddim beat, electronic drums, 100 BPM, jamaican patois, party, toasting" for classic. "dancehall ballad, slower riddim, romantic, 85 BPM" for romantic. "digital dancehall, 808 bass, trap influence, 105 BPM, modern" for modern.',keys:['Patois is the feature — use authentic Jamaican Creole phonetics and phrasing, not English translations','Toasting/deejaying: rapid-fire delivery with internal rhymes, syllable precision, rhythm over cadence','Hook/chorus must be sung by a different voice (or sung version) — creates conversation between deejay and chorus artist','Riddim (beat) evolution: shift the drum pattern slightly in verse 2 or bridge to keep energy building','Boasting and sound system culture: confidence, competitive wordplay, and party energy are the DNA'],artists:'Vybz Kartel · Sean Paul · Shenseea · Popcaan · Beenie Man · Shabba Ranks · Spice · Shaggy · Alkaline',counter:{device:'Riddim synth counter / chorus hook vs. deejay line / bass riddim counter',does:'Dancehall counter-melody lives in the riddim synth pattern and the interplay between the deejay\'s rapid-fire delivery and the chorus hook. The riddim bassline provides a hypnotic counter-rhythm under the vocal, and the synth stabs punctuate the deejay flow.',howto:'riddim synth counter-pattern, deejay flow vs. chorus hook contrast, bass riddim counter-rhythm',map:'Verse: deejay rides riddim, synth counter-line underneath / Chorus: hook rises over the riddim / Bridge: riddim strips or shifts, creating contrast / Outro: riddim counter-pattern becomes primary'},outliers:[{song:'"One Dance" — Drake ft. Wizkid & Kyla',rule:'Non-Jamaican rapper dominating a pure dancehall riddim without Jamaican credibility',result:'Broke global streaming records, introduced dancehall to mainstream audiences who never heard authentic riddim'},{song:'"Hotline Bling" — Drake',rule:'Trap beat with dancehall flow but no riddim — decoupling from the genre\'s sonic identity',result:'Proved Drake\'s delivery could carry the swagger while abandoning the beat signature'},{song:'"Shy Guy" — Diana King',rule:'90s pop-rap over dancehall riddim — global crossover that purists rejected',result:'Became a global smash that reintroduced dancehall to new markets, proved infectious riddim transcends genre gatekeeping'}],vocables:{sounds:'Yeah boy, whoa, bruk out, yo',when:'verse punctuation, chorus response, outro celebratory',suno_tag:'[Dancehall chant]',borrowed_from:'Jamaican sound system culture, reggae tradition',notes:'Dancehall vocables are confident and celebratory — they\'re part of the boasting tradition. Use them to emphasize swagger and party energy'}},
  bollywood:{dna:'Western pop production polish meets Indian classical ragas, dramatic emotional arcs, playback singing tradition. A single song carries the emotional journey of an entire scene: romance, betrayal, triumph, redemption. Tabla and dholak provide the rhythmic anchor. Strings soar over digital synths. Lyrics in Hindi/Urdu unlock Bollywood\'s emotional core.',structure:'Intro (orchestral swell, often 8-16 bars) → Verse 1 (narrative setup, cinematic) → Pre-Chorus (emotional rise) → Chorus (emotional peak, often sung by different playback singer) → Verse 2 (story develops) → Pre-Chorus → Chorus → Bridge (musical and emotional turning point) → Final Chorus (biggest) → Outro (often reprises opening theme). Key changes between chorus and final chorus are common.',suno:'"bollywood, hindi lyrics, tabla, dholak, strings, piano, emotional, dramatic, 110 BPM" for romantic. "bollywood epic, orchestral, full ensemble, powerful vocals, 100 BPM" for dramatic. "bollywood dance, upbeat, energetic, modern production, 120 BPM" for party.',keys:['Ragas: specific melodic sequences create emotional flavor — reference the raga in your Suno prompt (e.g., Raga Yaman for devotion, Raga Bhairav for morning melancholy)','Playback singing tradition: the lyrical content often switches between two characters or perspectives — use [Singer A] and [Singer B] tags','Chord movement: borrowed chords and dramatic key changes elevate emotion — minor to major shifts create emotional catharsis','Orchestration: strings should swell at emotional peaks, drums should build in verses, silence creates anticipation','Lyrics in Hindi/Urdu: mother, love, fate, destiny, separation, reunion are universal themes that unlock Bollywood\'s power'],artists:'A.R. Rahman · Arijit Singh · Shreya Ghoshal · Lata Mangeshkar · Kishore Kumar · Pritam · Vishal-Shekhar · Amit Trivedi',counter:{device:'String counter-melody / tabla rhythmic counter / second vocal harmony',does:'Bollywood\'s counter-melody is orchestral: sweeping strings play counter-lines under the main vocal, the tabla maintains a rhythmic counter-texture, and often a second playback singer will enter with a harmony or counter-melody in the chorus. The instruments are as emotionally expressive as the voice.',howto:'string counter-melody, tabla syncopation counter, playback singer harmony',map:'Verse: strings under the main vocal create emotional foundation / Chorus: strings and second vocal create full counterpoint / Bridge: tabla takes rhythmic lead as strings fade / Outro: orchestral counter-melody reprises theme'},outliers:[{song:'"Jai Ho" — A.R. Rahman',rule:'Bollywood song that won an Oscar — breaking the global gatekeeping of "serious" music',result:'Brought Bollywood to mainstream Western audiences, proved Indian classical influence could transcend cultural boundaries'},{song:'"Kabira" — Arijit Singh',rule:'Soft intimate solo vocal against minimal piano — abandoning the orchestral tradition',result:'Became a streaming phenomenon, showed Bollywood\'s emotional power survives without the orchestra'},{song:'"Besharam Rang" — Lata Mangeshkar & S.P. Balasubrahmanyam',rule:'Classical trained singers performing modern Bollywood — blending old vocal tradition with new production',result:'Iconic duet that showed classical training and modern pop production could create timeless songs'}],vocables:{sounds:'aah, ooh, na-na-na, hai',when:'chorus emotional peak, bridge vocal flourish, outro reprise',suno_tag:'[Bollywood vocal]',borrowed_from:'Indian classical vocal tradition, qawwali devotional singing',notes:'Bollywood vocables often function as instrumental fills — they extend the emotional arc rather than create rhythmic punctuation. Use them for vocal runs and emotional peaks'}},
  arabesque:{dna:'Quarter-tone maqam melodies that exist between the notes of Western scales, creating an emotional complexity no major/minor scale can capture. Oud and qanun weave ornamental tapestries. Darbuka rhythms anchor the soul. Vocal melisma (ornamental runs) carry emotion beyond lyrics. Arabic/Amazigh lyrics in a dignified, romantic, or defiant tone.',structure:'Intro (oud solo or instrumental maqam exploration, 8-16 bars) → Verse 1 (narrative or emotional declaration, sparse arrangement) → Chorus (main hook, often sung with full orchestra) → Verse 2 (story deepens or new perspective) → Chorus → Bridge (instrumental showcase or vocal improvisation section) → Final Chorus (grandest arrangement) → Outro (often reprises intro theme with fade). Instrumental sections are not breaks — they\'re essential storytelling moments.',suno:'"arabic, maqam, oud, qanun, darbuka, 100 BPM, emotional, middle eastern" for classic. "khaleeji, gulf pop, synthesizers, modern production, 110 BPM, celebratory" for khaleeji. "raï, north african, rebellious, 105 BPM, energetic" for raï.',keys:['Maqam: reference specific maqams in your prompt (Rast, Hijaz, Kurd, Nahawand) — each has distinct emotional signature','Quarter-tones: melisma (vocal runs) are the emotional language — encourage long ornamental runs over lyrics','Oud and qanun are characters: the instruments should be as emotionally present as the voice','Vocal ornamentation over lyrical clarity: the feeling matters more than understanding every word','Darbuka rhythms provide spiritual anchor: specify rhythm patterns (Baladi, Masmoudi, Fallahi) in your prompt'],artists:'Amr Diab · Fairuz · Umm Kulthum · Cheb Khaled · Nancy Ajram · Mohammed Abdu · Elissa · Cairokee',counter:{device:'Oud melody counter / qanun arpeggiation / darbuka syncopation',does:'Arabesque counter-melody is primarily instrumental: the oud plays a conversational melodic counter to the vocal, the qanun creates a shimmering harmonic counter-texture, and the darbuka syncopates against the main beat. The instruments are as vocally present as the singer.',howto:'oud counter-melody, qanun harmonic counter, darbuka rhythmic counter-syncopation',map:'Verse: oud provides sparse melodic counter under the vocal / Chorus: qanun fills with shimmering arpeggios / Bridge: oud takes full melodic lead, vocals become rhythm / Outro: oud and vocal interweave in conversation'},outliers:[{song:'"Umm Kulthum Concert Performance" — Umm Kulthum',rule:'30+ minute single songs with improvisation sections breaking every pop convention',result:'Considered the greatest Arab voice ever, proved extended emotional journey beats commercial concision'},{song:'"Tamer Hosny" — various collaborations',rule:'Egyptian pop with minimal maqam reference, pure Western chord progressions',result:'Dominating Arab charts while abandoning maqam tradition, proved accessibility could override tradition'},{song:'"Andalus Nights" — Fairuz',rule:'Lebanese folk tradition sung in classical maqam style in a globalized pop context',result:'Created a bridge between tradition and modernity, proved maqam and pop could enhance each other'}],vocables:{sounds:'ya, aah, yalla, oh',when:'bridge vocal improvisation, chorus emotional release, outro fade',suno_tag:'[Arabic vocal]',borrowed_from:'Islamic devotional call-to-prayer (adhan) vocal tradition, Quranic recitation',notes:'Arabesque vocables are ornamental and devotional — they extend emotional expression rather than create rhythmic punctuation. Melisma (runs) should be encouraged'}},
  mandopop:{dna:'Pentatonic melodies (five-note scales creating distinctly Chinese emotional flavor) layered with Western pop production, emotional ballad tradition, piano/string-driven arrangements. Mandarin lyrics unlock poetic depth — tonal language allows melodic nuances impossible in English. The influence of classical Chinese music runs deep, even in pop.',structure:'Intro (piano solo or orchestral swell, often 8-16 bars) → Verse 1 (narrative, intimate) → Pre-Chorus (emotional rise) → Chorus (melodic peak, anthemic) → Verse 2 (story deepens) → Pre-Chorus → Chorus → Bridge (turning point, often stripped or musically distinct) → Final Chorus (biggest production) → Outro (thematic reprise or fade). Ballads often stretch 4-5 minutes.',suno:'"mandopop, mandarin lyrics, piano, strings, emotional, ballad, 95 BPM" for ballad. "mandopop energetic, upbeat, modern pop production, 120 BPM" for uptempo. "mandopop hip-hop, rap elements, contemporary, 110 BPM" for modern.',keys:['Pentatonic scales: use do-re-mi-sol-la (no fa, no ti) for authentically Chinese emotional flavor','Tonal language: Mandarin has 4 tones — use this tonal variation in melody contours for authentic phrasing','Piano as lead instrument: prominent in verses and bridge, strings swell in choruses','Emotional ballad tradition: vulnerability and longing are central to the genre, love and loss are universal themes','Storytelling: each verse reveals a new facet of the emotional journey — second verse should deepen, not repeat'],artists:'Jay Chou · Eason Chan · JJ Lin · Faye Wong · Teresa Teng · G.E.M. · Jolin Tsai · Mayday',counter:{device:'Piano melody counter / string counter-line / secondary vocal harmony',does:'Mandopop counter-melody is orchestral: the piano plays an independent melody line under the vocal in verses, strings create a sweeping counter-line in the chorus, and often a layered vocal harmony or vocal harmony doubles the main melody. The arrangement is as important as the vocal.',howto:'piano counter-melody, string arrangement counter-line, vocal harmony layering',map:'Verse: piano plays counter-melody under sparse vocal / Chorus: strings swell with counter-line / Bridge: piano takes lead as vocal strips back / Outro: orchestral counter-melody reprises main theme'},outliers:[{song:'"Lovesong" — Jay Chou',rule:'Electronic production and rap flow breaking the ballad tradition',result:'One of the biggest mandopop hits, showed the genre could embrace modernity while keeping emotional core'},{song:'"Moonlight" — Teresa Teng',rule:'Timeless ballad with minimal production and purely acoustic arrangement',result:'Considered the greatest Mandarin song ever, proved emotional truth beats production sophistication'},{song:'"Oaoa" — G.E.M.',rule:'Yodeling vocal technique and alternative rock energy in a traditionally ballad-driven genre',result:'Global breakthrough that proved Mandopop could transcend the ballad tradition and still connect emotionally'}],vocables:{sounds:'aah, ooh, la-la, na-na',when:'chorus emotional peak, bridge vocal flourish, outro fade',suno_tag:'[Mandarin vocal]',borrowed_from:'Chinese classical vocal tradition, traditional opera (京剧) vocal techniques',notes:'Mandopop vocables often extend the emotional arc — they\'re vocal flourishes rather than rhythmic accents. Use them to emphasize the tonal language and emotional nuance'}},
  ...
  drill:{dna:'Cold minor-key sample loops, sliding 808 bass (pitch slides down or up rather than sitting on a note), percussive sliding hi-hats, halftime feel at 140–150 BPM, behind-the-beat flow, documentary street menace in lyrics, place-specific slang, no sentimentality. Drill is trap\'s colder, UK-grown cousin — emotional restraint as aesthetic discipline.',structure:'Hook-first opening is common: Hook (8 bars) → Verse 1 (16 bars) → Hook → Verse 2 (16 bars) → Hook → Outro. Traditional alternative: Intro (8 bars of loop + hi-hats) → Verse 1 → Hook → Verse 2 → Hook → Outro. Beat switches are rare but powerful when used. Pop Smoke and Headie One popularized the cold hook-first opening.',suno:'"UK drill, sliding 808 bass, dark piano loop, percussive sliding hi-hats, 140 BPM, cold, menacing" for UK drill. "Brooklyn drill, sliding 808, melodic sample loop, 145 BPM, aggressive" for NY drill. "Chicago drill, hard 808, dark synth loop, 145 BPM, grim" for Chicago drill. Always specify sliding 808s and BPM.',keys:['Sliding 808 bass is the genre signature — the pitch slides down (or up) rather than sitting on a note; name it explicitly in the prompt','Minor-key sample loops must feel cold and resigned — no major-key warmth, no uplifting progressions','Flow must ride behind the beat — the rapper arrives fractionally late on each bar to create the drag and menace feel','Lyrical content is documentary — specificity of block, street, consequence; generic threats read as fake drill','Halftime feel at 140–150 BPM — the drums are double-time over a halftime kick pattern; name both in the prompt'],artists:'Pop Smoke · Chief Keef · Headie One · Central Cee · Digga D · Fivio Foreign · Sheff G · G Herbo · Lil Durk · Skepta · Drake (drill-era collabs)',counter:{device:'Sliding 808 melodic counter / sample or piano loop counter-melody / ad-lib counter-voice',does:'The drill counter-melody lives in two places at once: the sliding 808 bass creates a melodic line that slides under the vocal phrasing, answering each bar with a pitch shift; and the sample or piano loop plays a continuous melodic counter-line that the rap bars respond to. Ad-libs (doubled hook lines, background "grr" or "ay") form a third counter-voice riding behind the main vocal.',howto:'sliding 808 bass as melodic counter, sample or piano loop counter-melody, ad-lib background counter-voice',map:'Intro: loop establishes melodic counter / Verse: 808 slides answer each bar-end / Hook: ad-lib layer counter-voices the main hook / Outro: loop alone leads the fade'},outliers:[{song:'"Dior" — Pop Smoke',rule:'Brooklyn drill single crossed over to US mainstream in 2019–2020 when the industry had considered UK-style drill untranslatable to US top 40',result:'Charted in the US Billboard Hot 100 and became posthumously synonymous with the NY drill sound — proved drill could carry mainstream hooks without abandoning its cold feel'},{song:'"I Don\'t Like" — Chief Keef ft. Lil Reese',rule:'Chicago drill released independently in 2012 with sparse production and unpolished delivery that major labels had considered unreleasable',result:'Remixed by Kanye West, signed Chief Keef to Interscope, and launched the drill genre into the mainstream — proved raw documentary authenticity beat industry polish'},{song:'"Doja" — Central Cee',rule:'UK drill with explicitly melodic singsong flow and a pop-leaning hook, departing from the genre\'s cold documentary tradition',result:'Went top 3 in the UK and charted in the US — proved drill could absorb melody without losing its sliding-808 identity'}],vocables:{sounds:'grr, ay, brr, woi, pew (gun-sound mimicry), "on god", "trust"',when:'hook punctuation, between bars as ad-lib texture, verse endings',suno_tag:'[Drill ad-lib]',borrowed_from:'dancehall toasting, Chicago street chant culture, UK roadman slang',notes:'Drill vocables are cold and percussive — never celebratory, never playful. The "grr" or "brr" at bar ends sets the aesthetic tone: menace, not party. Used sparingly; over-use reads as parody'}}
};
...
const GENRE_SUNO_BRACKETS = {
  ...
  reggae:     { verse:'[Verse | Conscious | Laid-Back | One-Drop]', chorus:'[Chorus | Anthemic | Uplifting | Singable]', bridge:'[Bridge | Dub | Atmospheric | Floating]', outro:'[Outro | Dub Vamp | Fading | Echo]', transitions:['[Intro | Riddim | One-Drop]','[Dub Break | Echo | Atmospheric]','[Bass Drop | Riddim]'], delivery:'Bridge should float over the dub section — melodic, not spoken. Mark the dub section as [Dub Break | Echoing | 8 bars]. Chorus should feel communal — add [Group Vocals].' },
  ...
  soul:       { verse:'[Verse | Testimony | Intimate | Gospel-Inflected]', chorus:'[Chorus | Declaration | Emotional Peak | Full]', bridge:'[Bridge | Darkest Moment | Raw | Confessional]', outro:'[Outro Vamp | Ascending | Ad-libs]', transitions:['[Pre-Chorus | Building]','[Instrumental Break | Soulful]'], delivery:'Use [Falsetto] on soaring lines. Bridge should be the rawest sung moment — voice stripped to its most vulnerable. Mark call-and-response in the outro: [Call] line then [Response] line.' },
  latin:      { verse:'[Verse | Narrative | Rhythmic | Conversational]', chorus:'[Chorus | Celebratory | Dance | Anthemic]', bridge:'[Bridge | Romantic | Intense | Passionate]', outro:'[Outro | Montuno | Fading | Dance]', transitions:['[Intro | Percussion Intro]','[Coro | Call and Response | Repeated]','[Instrumental Solo | Latin]'], delivery:'Mark the coro (chorus hook) as [Coro | Singable | Repeated]. Use [Percussion Break] between sections. Bridge should be the most passionate sung section — intensity over the rhythm.' },
  ...
  indie:      { verse:'[Verse | Intimate | Lo-Fi | Conversational]', chorus:'[Chorus | Anthemic | Jangly | Cathartic]', bridge:'[Bridge | Quiet | Reflective | Unexpected]', outro:'[Outro | Fading | Bittersweet]', transitions:['[Intro | Guitar Intro | Textured]','[Pre-Chorus | Building]','[Instrumental Break | Lo-Fi]'], delivery:'Bridge should be the quietest sung moment — almost a whisper but still melodic. Use [Falsetto] on emotional peaks. Mark lo-fi texture moments as [Texture | Atmospheric].' },
...
const SUBSTYLE_BRACKETS={
  ...
  // Brazilian
  'Bossa Nova':          { verse:'[Verse | Conversational | Warm | Sophistication]', hook:'[Chorus | Singable | Warm | Emotional]',   extra:['[Violão Break | Fingerpicked]','[Outro Vamp]'] },
  'Samba':               { verse:'[Verse | Narrative | Rhythmic Energy]',         hook:'[Chorus | Celebratory | Repeat]',         extra:['[Percussion Break]','[Outro | Groove Vamp]'] },
  'MPB':                 { verse:'[Verse | Poetic | Story-Driven]',               hook:'[Chorus | Emotional Declaration]',        extra:['[Violão Solo]','[Outro Vamp]'] },
  'Funk Carioca':        { verse:'[Verse | Rapid | Energetic | Aggressive]',      hook:'[Chorus | Party | Explosive]',            extra:['[Drum Break]','[Outro | High Energy]'] },
  'Sertanejo':           { verse:'[Verse | Storytelling | Romantic]',             hook:'[Chorus | Anthemic | Celebration]',       extra:['[Guitar Break]','[Outro | Singalong]'] },
  // Amapiano
  'Amapiano House':      { verse:'[Verse | Conversational | Groove-Led]',         hook:'[Chorus | Singalong | Repeated]',         extra:['[Piano Riff Break]','[Outro Vamp]'] },
  'Amapiano Ballad':     { verse:'[Verse | Emotional | Intimate]',               hook:'[Chorus | Soulful | Melodic]',            extra:['[Piano Solo]','[Outro | Slow Fade]'] },
  'Amapiano Energetic':  { verse:'[Verse | High Energy | Rapid Delivery]',        hook:'[Chorus | Maximum | Celebratory]',        extra:['[Drum Break | Intense]','[Outro | Explosive]'] },
  // Dancehall
  'Digital Dancehall':   { verse:'[Verse | Toasting | Fast-Paced | Riddim-Led]',  hook:'[Chorus | Sung Hook | Repeated]',         extra:['[Riddim Shift]','[Outro Vamp]'] },
  'Dancehall Romantic':  { verse:'[Verse | Crooning | Smooth Flow]',              hook:'[Chorus | Melodic | Slow Burn]',          extra:['[Riddim | Sensual]','[Outro | Fade]'] },
  'Dancehall Party':     { verse:'[Verse | Deejaying | High Energy]',             hook:'[Chorus | Celebration | Crowd]',          extra:['[Riddim Break | Maximum]','[Outro | Explosive]'] },
  // Bollywood
  'Bollywood Romantic':  { verse:'[Verse | Dramatic | Emotional Setup]',          hook:'[Chorus | Emotional Peak | Full Orchestra]', extra:['[String Break]','[Outro | Orchestral Reprise]'] },
  'Bollywood Epic':      { verse:'[Verse | Powerful | Narrative | Orchestral]',   hook:'[Chorus | Belted | Massive]',             extra:['[Bridge | Turning Point]','[Final Chorus | Biggest]'] },
  'Bollywood Dance':     { verse:'[Verse | Upbeat | Modern Production]',          hook:'[Chorus | Energetic | Celebration]',       extra:['[Rap/Spoken Section]','[Outro | High Energy]'] },
  'Bollywood Duet':      { verse:'[Verse A | Character Voice][Verse B | Contrasting Voice]', hook:'[Chorus | Two-Voice Harmony]',extra:['[Bridge | One Voice Solo]','[Outro | Duet Reprise]'] },
  // Arabesque
  'Maqam Classical':     { verse:'[Verse | Ornamental | Sparse | Oud-Led]',       hook:'[Chorus | Orchestral | Emotional]',        extra:['[Oud Solo | Improvisation]','[Outro Vamp]'] },
  'Khaleeji Gulf Pop':   { verse:'[Verse | Modern | Electronic Production]',      hook:'[Chorus | Celebration | Anthemic]',       extra:['[Synth Break | Modern]','[Outro | Dance Vamp]'] },
  'Raï North African':   { verse:'[Verse | Energetic | Rebellious]',              hook:'[Chorus | Powerful | Declaration]',       extra:['[Percussion Break]','[Outro | Intense Fade]'] },
  'Arabic Ballad':       { verse:'[Verse | Emotional | Melismatic]',              hook:'[Chorus | Ornamental | Full String]',     extra:['[Bridge | Stripped | Melisma]','[Outro | Fade]'] },
  // Mandopop
  'Mandopop Ballad':     { verse:'[Verse | Intimate | Piano-Driven]',             hook:'[Chorus | Emotional Peak | String Swell]',extra:['[Piano Solo | Emotional]','[Outro | Orchestral Reprise]'] },
  'Mandopop Uptempo':    { verse:'[Verse | Energetic | Pop Production]',          hook:'[Chorus | Catchy | Celebratory]',         extra:['[Modern Production Break]','[Outro | Upbeat Fade]'] },
  'Mandopop Hip-Hop':    { verse:'[Verse | Rap Flow | Contemporary]',             hook:'[Chorus | Sung | Melodic]',               extra:['[Rap Break | Dense Rhyme]','[Outro | Fusion]'] },
  'Mandopop Rock':       { verse:'[Verse | Driven | Guitar-Based]',               hook:'[Chorus | Powerful | Anthemic]',          extra:['[Guitar Solo | Energetic]','[Outro | Rock Out]'] },
};
...
[Spoken] — spoken word or monologue (use SPARINGLY — only when the genre specifically calls for it, like hip-hop storytelling or punk breakdowns. Most bridges should be SUNG, not spoken.)
...
IMPORTANT: Bridges should almost always be SUNG — with melody and emotion. Do NOT default to [Spoken] on bridges. A bridge's power comes from the vocal melody shifting, not from dropping into speech.
...
ENERGY ARC: The verse should feel noticeably lower energy than the chorus. The bridge should feel like a completely different world — more vulnerable or more intense. The outro should feel like release after the final chorus peak.`;
    ...
    return `SUNO-OPTIMIZED BRACKETS: Use section brackets with mood markers on every section: [Verse 1 | Intimate | 4/10], [Pre-Chorus | Building | 6/10], [Chorus | Full Production | 9/10], [Bridge | Stripped | 5/10], [Final Chorus | Maximum | 10/10]. Add inline delivery tags [Whispered], [Falsetto] on their own line before any line requiring special vocal delivery. Avoid [Spoken] on bridges — bridges should be sung.`;
  }
...
const BRIDGE_ARCHETYPES = [
  ...
  },
  {
    ...
    bars: '6–8',
    delivery: 'Different vocal register or approach than any other section. If verses were belted, bridge should be hushed and intimate. If verses were intimate, bridge should soar. Change the instrument.',
...
const GENRE_SECTION_DNA = {
  ...
  neosoul: {
    bridge: {
      ...
      preferred_bridge: ['Confessional Drop', 'Pre-Outro Vamp Build', 'Lyric Callback / Recontextualise', 'Left-Turn Narrative'],
  ...
  altrock: {
    bridge: {
      ...
      preferred_bridge: ['Rhythmic Breakdown', 'Confessional Drop', 'Escalation Climb'],
