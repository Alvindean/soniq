...
module.exports = async function handler(req, res) {
  ...
  const record = JSON.stringify({
    ...
    soniq_share,
    writer_share,
    // Publisher metadata — Soniq Publishing / Alvin Dean Warren
    publisher_name: 'Soniq Publishing',
    publisher_owner: 'Alvin Dean Warren',
    publisher_dba: 'Alvo',
    copyright_notice: `© ${new Date().getFullYear()} ${writer_name} / Soniq Publishing (Alvin Dean Warren). All rights reserved.`,
    genre: genre || null,
    topic: topic || null,
